...
class Toolbar {
    ...
    /**
     * Renders the GitHub dropdown items with provided onclick handlers.
     * @public
     * @param {Function} initRepo_onclick - Handler for "Initialise a Repo"
     * @param {Function} editProject_onclick - Handler for "Edit project"
     * @returns {void}
     */
    renderGitHubDropdown(initRepo_onclick, editProject_onclick) {
        const initRepo = docById("initRepo");
